...
class Book {
  ...
  printInfo() {
    console.log(
      `Book title: "${this.title}", Author: ${this.author}, Year: ${this.year}`,
    );
  }
}
...
const songOfIceAndFire = new Book(
...
const originalBook = new Book('Harry Potter', 'J.K. Rowling', 2001);

const newEBook = EBook.expandBook(originalBook, '.pdf');
